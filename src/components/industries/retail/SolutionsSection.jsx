      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 space-y-6">
            <h3 className="text-3xl font-bold text-gray-800">{data.netSuiteSolutions[activeSolution].title}</h3>
            ...
            <div className="space-y-3 mb-6">
              ...
              {data.netSuiteSolutions[activeSolution].features.map((feature, index) => (
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-blue-700 font-semibold">Result: {data.netSuiteSolutions[activeSolution].benefits}</span>
              </div>
            </div>
